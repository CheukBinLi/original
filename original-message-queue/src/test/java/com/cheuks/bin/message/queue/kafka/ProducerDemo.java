...
public class ProducerDemo {
	...
	void a() {
		...
		for (int i = 10000; i < 10010; i++) {
			...
			producer.send(new ProducerRecord<String, String>("afterSale1", Integer.toString(i), Integer.toString(i)));
			// producer.send(new ProducerRecord<String, String>("ddorders", "asdf1", "1asdfsdf"));
		}
		producer.close();
