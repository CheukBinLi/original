...
public class SimpleRmiBeanFactory_ok2_bak implements RmiBeanFactory {

	private final static Logger LOG = LoggerFactory.getLogger(SimpleRmiBeanFactory_ok2_bak.class);
	...
	public static void main(String[] args) throws Throwable {
		...
		SimpleRmiBeanFactory_ok2_bak rsf = new SimpleRmiBeanFactory_ok2_bak();
