 ...
 * @E-mail 邮箱：chaobin.li@meicloud.com 类说明
 */
public class JmailUtil {
	...
	public void send(final MailModel mailModel) throws MessagingException {
		...
		trans.sendMessage(msg, new Address[] {
				new InternetAddress(mailModel.getReceiveAddress())
		}); //发送邮件
		trans.close(); //关闭连接
	}
	...
	public static void main(String[] args) throws MessagingException {
		...
		MailModel mailModel = new MailModel("mdp-admin", "admin4@MDP", "smtp.midea.com", 25, true, "smtp", "20796698@qq.com", "工文", "工文");
		//        MailModel mailModel=new MailModel("f41234567890f4@163.com","zxcvbnm0","smtp.163.com",false,"smtp","20796698@qq.com","工文","工文");
