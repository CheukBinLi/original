...
public class CreateFile2 {
	...
	public static void create(Class<?> c, Class<?> idType, boolean SimpleName, boolean isSignleFloder) throws IOException, TemplateException {
		...
		String path = Thread.currentThread().getContextClassLoader().getResource("").getPath() + CreateFile2.class.getPackage().getName().replaceAll("[.]", "/") + "/";
		System.err.println(path);
		System.err.println(CreateFile2.class.getPackage().getName());
	...
	public static void main(String[] args) throws IOException, TemplateException {
		...
		// CreateFile2.create(Fundraising.class, Integer.class, true, true);
		// CreateFile2.create(FundraisingLog.class, Integer.class, true, true);
		// CreateFile2.create(WeiXinInfo.class, String.class, true, true);
		// CreateFile2.create(UnifiedOrder.class, String.class, true, true);
	}
