...
public class NewsMessageResponse implements Serializable {
    ...
    public NewsMessageResponse setToUserName(String toUserName) {
    ...
    public NewsMessageResponse setFromUserName(String fromUserName) {
    ...
    public NewsMessageResponse setCreateTime(Long createTime) {
    ...
    public NewsMessageResponse setMsgType(String msgType) {
